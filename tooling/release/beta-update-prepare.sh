...
standard-version -t kdisplay\@ --skip.commit true --skip.tag true --preMajor --release-as $NEXT_BETA_VERSION
...
git tag -a "kdisplay@${NEXT_BETA_VERSION}" -m "Create beta release ${NEXT_BETA_VERSION}."
