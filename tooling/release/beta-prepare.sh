...
standard-version -t kdisplay\@ --skip.commit true --skip.tag true --preMajor --release-as $BETA_VERSION
...
git tag -a "kdisplay@${BETA_VERSION}" -m "Create beta release ${BETA_VERSION}."
